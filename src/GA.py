...
class Fixed(Candidate):
    ...
    def no_duplicates(self):
        #print("Rows: " + str(len(self.values)) + " Cols: " + str(len(self.values[0])))
        for row in range(0, Nd):
...
# s = Sudoku()
# board = "060209000000030010100600009420500090005302860083100024870906035340050270206073001"
# #grid = np.array(list(board)).reshape((9,9)).astype(int)
# grid = tests['case1']
# #print(grid)
# s.load(grid)
